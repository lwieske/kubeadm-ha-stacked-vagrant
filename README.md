...
==> lb01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_lb01_1607673441210_60306
...
==> lb02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_lb02_1607673472364_78734
...
==> m01: Importing base box 'k8s-1.20.0'...
==> m01: Matching MAC address for NAT networking...
==> m01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m01_1607673509213_84618
...
==> m01: Running provisioner: shell...
    ...
    m01: [init] Using Kubernetes version: v1.20.0
    ...
    m01: [apiclient] All control plane components are healthy after 25.132915 seconds
    ...
    m01: a2d0d14d1c8dc9ada0ec06154516ad43f18cdf2c3c858bb415aeb8cf47b27be7
    ...
    m01:     --discovery-token-ca-cert-hash sha256:b078c7ba24e5f50af00ec4394594a72536a9622e0f382e83cefbca48060a7a5b \
    m01:     --control-plane --certificate-key a2d0d14d1c8dc9ada0ec06154516ad43f18cdf2c3c858bb415aeb8cf47b27be7
    m01:
...
==> m02: Importing base box 'k8s-1.20.0'...
==> m02: Matching MAC address for NAT networking...
==> m02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m02_1607673580703_20160
...
==> m02: Running provisioner: shell...
    ...
    m02: ++ DISCOVERY_TOKEN_CA_CERT_HASH=b078c7ba24e5f50af00ec4394594a72536a9622e0f382e83cefbca48060a7a5b
    m02: +++ cat /vagrant/params/certificate-key
    m02: ++ CERTIFICATE_KEY=a2d0d14d1c8dc9ada0ec06154516ad43f18cdf2c3c858bb415aeb8cf47b27be7
    m02: +++ /sbin/ip -o -4 addr list eth1
    m02: +++ awk '{print $4}'
    m02: +++ cut -d/ -f1
    m02: ++ kubeadm join 192.168.10.10:6443 --control-plane --apiserver-advertise-address 192.168.10.102 --token abcdef.0123456789abcdef --discovery-token-ca-cert-hash sha256:b078c7ba24e5f50af00ec4394594a72536a9622e0f382e83cefbca48060a7a5b --certificate-key a2d0d14d1c8dc9ada0ec06154516ad43f18cdf2c3c858bb415aeb8cf47b27be7
    ...
    m02: [mark-control-plane] Marking the node m02 as control-plane by adding the labels "node-role.kubernetes.io/master=''" and "node-role.kubernetes.io/control-plane='' (deprecated)"
...
==> m03: Importing base box 'k8s-1.20.0'...
==> m03: Matching MAC address for NAT networking...
==> m03: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m03_1607673645582_29106
...
==> m03: Running provisioner: shell...
    ...
    m03: ++ DISCOVERY_TOKEN_CA_CERT_HASH=b078c7ba24e5f50af00ec4394594a72536a9622e0f382e83cefbca48060a7a5b
    m03: +++ cat /vagrant/params/certificate-key
    m03: ++ CERTIFICATE_KEY=a2d0d14d1c8dc9ada0ec06154516ad43f18cdf2c3c858bb415aeb8cf47b27be7
    ...
    m03: [mark-control-plane] Marking the node m03 as control-plane by adding the labels "node-role.kubernetes.io/master=''" and "node-role.kubernetes.io/control-plane='' (deprecated)"
...
==> w01: Importing base box 'k8s-1.20.0'...
==> w01: Matching MAC address for NAT networking...
==> w01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w01_1607673703785_59511
...
==> w02: Importing base box 'k8s-1.20.0'...
==> w02: Matching MAC address for NAT networking...
==> w02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w02_1607673770545_96729
...
==> w03: Importing base box 'k8s-1.20.0'...
==> w03: Matching MAC address for NAT networking...
==> w03: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w03_1607673830248_98738
...
m01    Ready    control-plane,master   6m23s   v1.20.0
m02    Ready    control-plane,master   5m30s   v1.20.0
m03    Ready    control-plane,master   4m24s   v1.20.0
w01    Ready    <none>                 3m14s   v1.20.0
w02    Ready    <none>                 2m13s   v1.20.0
w03    Ready    <none>                 66s     v1.20.0
