# kubeadm-ha-stacked-vagrant / Kubernetes v1.20.5
...
==> lb01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_lb01_1616138903376_95623
...
==> lb02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_lb02_1616138931095_7794
...
==> m01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m01_1616138958177_54708
...
==> m01: Running provisioner: shell...
    ...
    m01: [init] Using Kubernetes version: v1.20.5
    ...
    m01: [apiclient] All control plane components are healthy after 78.597245 seconds
    ...
    m01: 0069f8b57fbba95c97e40b10d0aa214534aa37d856341f0637f269525bcb3468
    ...
    m01:     --discovery-token-ca-cert-hash sha256:5eef0448426041b20712eb8b59cfce70c411af1a25a8fdf639d29a5853ce7e10 \
    m01:     --control-plane --certificate-key 0069f8b57fbba95c97e40b10d0aa214534aa37d856341f0637f269525bcb3468
    m01:
...
==> m02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m02_1616139073217_90803
...
==> m02: Running provisioner: shell...
    ...
    m02: ++ DISCOVERY_TOKEN_CA_CERT_HASH=5eef0448426041b20712eb8b59cfce70c411af1a25a8fdf639d29a5853ce7e10
    m02: +++ cat /vagrant/params/certificate-key
    m02: ++ CERTIFICATE_KEY=0069f8b57fbba95c97e40b10d0aa214534aa37d856341f0637f269525bcb3468
    m02: +++ /sbin/ip -o -4 addr list eth1
    m02: +++ awk '{print $4}'
    m02: +++ cut -d/ -f1
    m02: ++ kubeadm join 192.168.10.10:6443 --control-plane --apiserver-advertise-address 192.168.10.102 --token abcdef.0123456789abcdef --discovery-token-ca-cert-hash sha256:5eef0448426041b20712eb8b59cfce70c411af1a25a8fdf639d29a5853ce7e10 --certificate-key 0069f8b57fbba95c97e40b10d0aa214534aa37d856341f0637f269525bcb3468
...
==> m03: Setting the name of the VM: kubeadm-ha-stacked-vagrant_m03_1616139137616_64651
...
==> m03: Running provisioner: shell...
    ...
    m03: ++ DISCOVERY_TOKEN_CA_CERT_HASH=5eef0448426041b20712eb8b59cfce70c411af1a25a8fdf639d29a5853ce7e10
    m03: +++ cat /vagrant/params/certificate-key
    m03: ++ CERTIFICATE_KEY=0069f8b57fbba95c97e40b10d0aa214534aa37d856341f0637f269525bcb3468
    m03: +++ cut -d/ -f1
...
==> w01: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w01_1616139191520_70343
...
==> w02: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w02_1616139244899_2964
...
==> w03: Setting the name of the VM: kubeadm-ha-stacked-vagrant_w03_1616139311215_72632
...
m01    Ready    control-plane,master   6m17s   v1.20.5
m02    Ready    control-plane,master   5m28s   v1.20.5
m03    Ready    control-plane,master   4m22s   v1.20.5
w01    Ready    <none>                 3m23s   v1.20.5
w02    Ready    <none>                 2m17s   v1.20.5
w03    Ready    <none>                 67s     v1.20.5
...
==> Combining 278 screenshots into GIF file...
